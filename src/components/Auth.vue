<template>
  <div class="auth">
    <div class="auth__title">
      Authorize and get access to your comix catalogue!
    </div>
    <button
      class="button button_blue button_big"
      @click="onAuth"
    >
      <div class="button__text">
        Authorize via
      </div>
      <div class="button__icon button__icon_right">
...
export default {
  ...
  methods: {
    ...
    googleAuthSuccessResponse (res) {
      this.$cookie.set('id_token', res.getAuthResponse().id_token)
      this.SET_USER({
    ...
    onAuth () {
      this.$gAuth.signIn(this.googleAuthSuccessResponse)
    }
  }
}
</script>
